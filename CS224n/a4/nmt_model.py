...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        embed_padded = self.model_embeddings.source(source_padded)
        input_source = nn.utils.rnn.pack_padded_sequence(embed_padded, source_lengths)
        enc_hiddens, (last_hidden, last_cell) = self.encoder(input_source)
